...
?>
					<tr>
						<td>
								...
								$query = mysql_query("SELECT sol.solicitud_id, sol.dataSolicitud, t.nom, u2.nomComplet, sol.estat from Tasca t,Solicitud sol, Oferta o, Usuari u, Usuari u2 WHERE u.usuari_id='$usuari_id' && sol.oferta_id=o.oferta_id && u2.usuari_id=o.usuari_id && u.usuari_id=sol.usuari_id && t.tasca_id=o.tasca_id ORDER BY sol.dataSolicitud DESC;");
								if (mysql_num_rows($query) == 0)
								{
									echo
									'<h3 style="color:#08C; margin:0px;">Sol&#183licituds enviades</h3>
									<table>
										<tr>
											<td>
												<div class="alert alert-info" style="padding-right:10px; padding-left:10px; margin-top: 15px; margin-left: 0px;">
													<h5 style = "margin:0px;">Sembla que no has enviat cap sol&#183licitud!</h5>
												</div>
											</td>
										</tr>
									</table>';
